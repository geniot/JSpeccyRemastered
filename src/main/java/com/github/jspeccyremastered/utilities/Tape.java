...
import com.github.jspeccyremastered.machine.Clock;
 ...
 * @author jsanchez
 */
public class Tape implements com.github.jspeccyremastered.machine.ClockTimeoutListener {
    ...
    public Tape(JSpeccySettings tapeSettings) {
    ...
    private String getBlockType(int block) {
        java.util.ResourceBundle bundle =
                java.util.ResourceBundle.getBundle("com/github/jspeccyremastered/utilities/Bundle"); // NOI18N
