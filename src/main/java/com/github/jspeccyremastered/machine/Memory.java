...
import com.github.jspeccyremastered.porst.jhexview.IDataChangedListener;
import com.github.jspeccyremastered.snapshots.MemoryState;
...
public final class Memory {
    ...
    public MemoryState getMemoryState() {
        ...
        state.setMf128on48k(settings.isMf128On48K());
    ...
    public void setMemoryState(MemoryState state) {
        ...
        settings.setMf128On48K(state.isMf128on48k());
...
//            System.out.println("LEC page " + activePageLEC);
    ...
    private boolean loadRomAsResource(String filename, byte[][] rom, int page, int size) {
        ...
        if (inRom == null) {
            String msg =
                    java.util.ResourceBundle.getBundle("com/github/jspeccyremastered/machine/Bundle").getString(
                            "RESOURCE_ROM_ERROR");
    ...
    private class MemoryDataProvider implements com.github.jspeccyremastered.porst.jhexview.IDataProvider {
